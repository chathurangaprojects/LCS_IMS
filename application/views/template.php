...
<ul id="navigation">
<li>
    <a href="<?php echo base_url(); ?>" class="sf-with-ul" style="cursor: pointer;">
        <img src="<?php echo base_url(); ?>template_resources/images/dashboard.png" alt="Dashboard" style="margin: 2px 0 0 12px;" />
    </a>
</li>
